...
#let template = tufted.tufted-web.with(
  ...
  header-links: (
    "/": "Home",
    "/Blog/": "Blog",
    // Hidden for now. To bring a section back: un-comment its link below
    // AND rename its folder back (content/_CV -> content/CV, etc.).
    // "/CV/": "CV",
    // "/Docs/": "Docs",
  ),
  
  /// 网站的站点标题。会显示在浏览器标签页以及 SEO/社交分享卡片中。
  website-title: "YpLarryWang",
  /// 网站作者。用于生成 <meta name="author"> 标签。（可选）
  author: "Yupei Wang",
  /// 网站描述。用于 SEO 搜索引擎摘要和社交媒体分享预览。（可选）
  description: "Yupei Wang's personal site and blog.",
  /// 站点的根 URL (例如 "https://example.com")。用于生成 Canonical URL 元数据。（可选）
  website-url: "https://ypwang.one/",
